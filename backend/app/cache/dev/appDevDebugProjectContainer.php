...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_rest.request_matcher.9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305' => 'getFosRest_RequestMatcher_9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305Service',
            'fos_rest.request_matcher.d85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148' => 'getFosRest_RequestMatcher_D85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148Service',
            'fos_rest.request_matcher.efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9' => 'getFosRest_RequestMatcher_Efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9Service',
            ...
            'web_consul_ebay_api.finding' => 'getWebConsulEbayApi_FindingService',
            'web_consul_ebay_api.main' => 'getWebConsulEbayApi_MainService',
            'web_consul_ebay_api.make_call' => 'getWebConsulEbayApi_MakeCallService',
            'web_consul_ebay_api.shopping' => 'getWebConsulEbayApi_ShoppingService',
            'web_consul_ebay_api.trading' => 'getWebConsulEbayApi_TradingService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'hackathon', 'user' => 'hackathon', 'password' => 12345678, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Hack/Bundle/ProxyBundle/Resources/config/doctrine') => 'Hack\\Bundle\\ProxyBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Hack\\Bundle\\ProxyBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('HackProxyBundle' => 'Hack\\Bundle\\ProxyBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_44400a405b258660ad806875d84bbfe9c206e213a80c4c22b3341ad2c64b5906');
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305'), array('priorities' => array(0 => 'html', 1 => 'json', 2 => 'xml'), 'fallback_format' => NULL, 'prefer_extension' => false, 'methods' => NULL, 'stop' => false));
        $instance->add($this->get('fos_rest.request_matcher.efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9'), array('fallback_format' => 'rss', 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0', 'priorities' => array()));
        $instance->add($this->get('fos_rest.request_matcher.d85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148'), array('priorities' => array(0 => 'jsonp'), 'fallback_format' => false, 'prefer_extension' => '2.0', 'methods' => NULL, 'stop' => false));
    ...
    {
        return $this->services['fos_rest.mime_type_listener'] = new \FOS\RestBundle\EventListener\MimeTypeListener(array('enabled' => true, 'formats' => array('json' => array(0 => 'application/json', 1 => 'application/x-json', 2 => 'application/vnd.example-com.foo+json'), 'rss' => 'application/rss+xml', 'jpg' => 'image/jpeg', 'png' => 'image/png'), 'service' => NULL, 'jsonp' => 'application/javascript+jsonp'), $this->get('fos_rest.format_negotiator'));
    }
    ...
    {
        return $this->services['fos_rest.routing.loader.reader.action'] = new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($this->get('annotation_reader'), $this->get('fos_rest.request.param_fetcher.reader'), $this->get('fos_rest.inflector.doctrine'), true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true));
    }
    ...
    {
        return $this->services['fos_rest.routing.loader.xml_collection'] = new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($this->get('file_locator'), $this->get('fos_rest.routing.loader.processor'), true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), NULL);
    }
    ...
    {
        return $this->services['fos_rest.routing.loader.yaml_collection'] = new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($this->get('file_locator'), $this->get('fos_rest.routing.loader.processor'), true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), NULL);
    }
    ...
    {
        $this->services['fos_rest.view_handler'] = $instance = new \FOS\RestBundle\View\ViewHandler(array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), 400, 204, false, array('html' => 302), 'twig');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Hack\\Bundle\\ProxyBundle' => ($this->targetDirs[3].'/src/Hack/Bundle/ProxyBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'WebConsul\\EbayApiBundle' => ($this->targetDirs[3].'/vendor/webconsul/ebay-api-bundle/WebConsul/EbayApiBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Hack/Bundle/ProxyBundle/Resources/views'), 'HackProxy');
        $instance->addPath(($this->targetDirs[3].'/vendor/webconsul/ebay-api-bundle/WebConsul/EbayApiBundle/Resources/views'), 'WebConsulEbayApi');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('df16885667f65ed1e62b43d790221871836876a8');
    }
    ...
    /**
     * Gets the 'web_consul_ebay_api.finding' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebConsul\EbayApiBundle\Service\FindingService A WebConsul\EbayApiBundle\Service\FindingService instance.
     */
    protected function getWebConsulEbayApi_FindingService()
    {
        return $this->services['web_consul_ebay_api.finding'] = new \WebConsul\EbayApiBundle\Service\FindingService();
    }

    /**
     * Gets the 'web_consul_ebay_api.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebConsul\EbayApiBundle\Call\BaseCall A WebConsul\EbayApiBundle\Call\BaseCall instance.
     */
    protected function getWebConsulEbayApi_MainService()
    {
        return $this->services['web_consul_ebay_api.main'] = new \WebConsul\EbayApiBundle\Call\BaseCall(array('auth_token' => 'YOUR TOKEN FOR TESTING API CALLS', 'application_keys' => array('sandbox' => array('dev_id' => 'd1f44741-9a1f-4d0d-acb3-31fa07ba0dd5', 'app_id' => 'eBayc1a47-d174-4cdf-b717-e905416db46', 'cert_id' => 'cba62b9e-7358-4fa1-82c1-5b444b471424'), 'production' => array('dev_id' => 'd1f44741-9a1f-4d0d-acb3-31fa07ba0dd5', 'app_id' => 'eBayc1a47-d174-4cdf-b717-e905416db46', 'cert_id' => 'cba62b9e-7358-4fa1-82c1-5b444b471424'))));
    }

    /**
     * Gets the 'web_consul_ebay_api.make_call' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebConsul\EbayApiBundle\Service\MakeCallService A WebConsul\EbayApiBundle\Service\MakeCallService instance.
     */
    protected function getWebConsulEbayApi_MakeCallService()
    {
        return $this->services['web_consul_ebay_api.make_call'] = new \WebConsul\EbayApiBundle\Service\MakeCallService($this->get('jms_serializer'));
    }

    /**
     * Gets the 'web_consul_ebay_api.shopping' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebConsul\EbayApiBundle\Service\ShoppingService A WebConsul\EbayApiBundle\Service\ShoppingService instance.
     */
    protected function getWebConsulEbayApi_ShoppingService()
    {
        return $this->services['web_consul_ebay_api.shopping'] = new \WebConsul\EbayApiBundle\Service\ShoppingService();
    }

    /**
     * Gets the 'web_consul_ebay_api.trading' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebConsul\EbayApiBundle\Service\TradingService A WebConsul\EbayApiBundle\Service\TradingService instance.
     */
    protected function getWebConsulEbayApi_TradingService()
    {
        return $this->services['web_consul_ebay_api.trading'] = new \WebConsul\EbayApiBundle\Service\TradingService();
    }
    ...
    /**
     * Gets the 'fos_rest.request_matcher.9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305Service()
    {
        return $this->services['fos_rest.request_matcher.9e7bb8e8314a0cbfde7afa71a47927836e70574c10b0a84a30b29988b4c9bb2b1b41d305'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/liip/hello/rest', NULL, NULL);
    }

    /**
     * Gets the 'fos_rest.request_matcher.d85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_D85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148Service()
    {
        return $this->services['fos_rest.request_matcher.d85bfb56cb8b3caaf2952fb7ebc4823c1b3d64f860e58fc4f4c0ef16712cd699ea554148'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/liip/jsonp', NULL, NULL);
    }

    /**
     * Gets the 'fos_rest.request_matcher.efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_Efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9Service()
    {
        return $this->services['fos_rest.request_matcher.efaa4630dd51922530bc9978debeaab2b0562af04033c840cc5acfdc281ad0cd65ff26a9'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/liip/customHandler', NULL, NULL);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56472ed103ad10.21255705')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HackProxyBundle' => 'Hack\\Bundle\\ProxyBundle\\HackProxyBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'WebConsulEbayApiBundle' => 'WebConsul\\EbayApiBundle\\WebConsulEbayApiBundle',
            ...
            'database_user' => 'hackathon',
            'database_password' => 12345678,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'df16885667f65ed1e62b43d790221871836876a8',
            'web_consul_ebay_api' => array(
                'auth_token' => 'YOUR TOKEN FOR TESTING API CALLS',
                'application_keys' => array(
                    'sandbox' => array(
                        'dev_id' => 'd1f44741-9a1f-4d0d-acb3-31fa07ba0dd5',
                        'app_id' => 'eBayc1a47-d174-4cdf-b717-e905416db46',
                        'cert_id' => 'cba62b9e-7358-4fa1-82c1-5b444b471424',
                    ),
                    'production' => array(
                        'dev_id' => 'd1f44741-9a1f-4d0d-acb3-31fa07ba0dd5',
                        'app_id' => 'eBayc1a47-d174-4cdf-b717-e905416db46',
            ...
            'kernel.secret' => 'df16885667f65ed1e62b43d790221871836876a8',
            ...
            'fos_rest.format_listener.rules' => array(
                ...
                1 => array(
                    'path' => '^/liip/customHandler',
                    'fallback_format' => 'rss',
                    'host' => NULL,
                    'methods' => NULL,
                    'stop' => false,
                    'prefer_extension' => true,
                    'exception_fallback_format' => 'rss',
                    'priorities' => array(
                ...
                2 => array(
                    ...
                    'methods' => NULL,
                    'stop' => false,
                    'exception_fallback_format' => false,
                ),
                3 => array(
                    'path' => '^/',
                    'priorities' => array(
